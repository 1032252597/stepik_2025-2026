---
## Front matter
title: "Отчёт по выполнению внешнего курса на платформе Stepik. Этап 1"
subtitle: "Введение"
...
Ввожу нужные команды в терминал, чтобы сгенерировать файл, в котором будут все строчки из этих произведений, содержащие “love” и загружаю этот файл на платформу.([рис. @fig-032]).

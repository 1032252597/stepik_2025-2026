---
## Front matter
title: "Отчёт по выполнению внешнего курса на платформе Stepik. Этап 2"
...
Если в сессии tmux осталась только одна вкладка (окно), и в ней выполнить exit (или закрыть последний процесс в ней), то эта вкладка закроется. Так как вкладок больше нет, сессия завершается, и tmux прекращает работу. ([рис. @fig-022]).
...
Просматриваю видео и читаю информацию, так как мне хватает вируальной машины для выполнения задач и на моем компьютере установлена другая ОС, то установка Linux не требуется. ([рис. @fig-029]).
